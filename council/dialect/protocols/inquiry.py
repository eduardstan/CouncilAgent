"""InquiryAutomaton — information-seeking dialogue (Walton-Krabbe 1995).

Agents seek information via Question/Clarify; transitions to vote when
all questions have been addressed or max_rounds reached.
"""
...
_OPEN = frozenset({
    ...
    Force.CONCEDE, Force.PASS,
})
_VOTE = frozenset({Force.VOTE, Force.ABSTAIN})


class InquiryAutomaton(ProtocolAutomaton):
